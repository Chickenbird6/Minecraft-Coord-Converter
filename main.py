...
# Functions
# Example Coords for testing X: 69 Z: 420
def thickBar(length):
...
while True:
    ...
    if choice == "1":
        getCoords()
        if len(coords) == 2:
            output = "Coords: " + str(coords[0]) + " " + str(coords[1])
        elif len(coords) == 3:
            output = "Coords: " + str(coords[0]) + " " + str(coords[2])
        print(output)
        thinBar(len(output))
    ...
    if choice == "4":
        getCoords()
        if len(coords) == 2:
            output = ".b goto " + str(coords[0]) + " " + str(coords[1])
        elif len(coords) == 3:
            output = ".b goto " + str(coords[0]) + " " + str(coords[2])
        print(output)
        thinBar(len(output))
    ...
    if choice == "5":
        ...
        nc = getNether(coords)
        if len(nc) == 2:
            output = ".b goto " + str(nc[0]) + " " + str(nc[1])
        elif len(nc) == 3:
            output = ".b goto " + str(coords[0]) + " " + str(coords[2])
        print(output)
        thinBar(len(output))
